...
Define el andamiaje base del backend de Asiringui: un proyecto Python gestionado con `uv`, una aplicación FastAPI ejecutable con endpoint de salud, configuración tipada por entorno, un contrato base de errores estructurados, tooling de calidad/testing y documentación de operación. Es la fundación reutilizable sobre la que se construirán los módulos de negocio posteriores.
