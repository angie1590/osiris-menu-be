...
Scaffolding del frontend `osiris-menu-fe`: stack obligatorio, cliente API base (Axios con `X-Request-Id` y envelope de error), cliente WebSocket base, estructura de carpetas dedicada, vistas placeholder enrutadas por perfil y comandos de calidad.
